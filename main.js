...
(function() {
  ...
  var ctaDesktop = document.querySelector('.nav-cta-scroll');
  ...
  function onScroll() {
    ...
    if (cta) {
      if (pastHero) { cta.classList.add('visible'); } else { cta.classList.remove('visible'); }
    }
    if (ctaDesktop) {
      if (pastHero) { ctaDesktop.classList.add('visible'); } else { ctaDesktop.classList.remove('visible'); }
    }
  }
